...
<div class="row">
	...
	<div class="col-xs-12 col-sm-12 col-md-2 col-lg-2" style="padding-top: 8px">
		<select id="cant" name="cant" class="select2">
			<option value="10" selected>10 Productos con más % de utilidad</option>
			<option value="20">20 Productos con más % de utilidad</option>
			<option value="50">50 Productos con más % de utilidad</option>
			<option value="200">200 Productos con más % de utilidad</option>
			<option value="500">500 Productos con más % de utilidad</option>
			<option value="1000">1000 Productos con más % de utilidad</option>
			<option value="5000">5000 Productos con más % de utilidad</option>
		</select> 
	</div>	
