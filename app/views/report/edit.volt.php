...
<html>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <h2 class="page-header">Editar el reporte <strong><?php echo $report->name; ?> (<?php echo $report->code; ?>)</strong></h2>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <form action = "<?php echo $this->url->get('report/edit'); ?>/<?php echo $report->idReport; ?>" method="post" class="form-horizontal block block-default" role="form">
                <div class="form-group">
                    <label class="col-xs-12 col-sm-12 col-md-3 col-lg-3 control-label">
                        <span class="required">*</span>Código
                    </label>
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                        <?php echo $ReportForm->render('code'); ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                        <?php echo $ReportForm->render('name'); ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                        <?php echo $ReportForm->render('description'); ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                        <?php echo $ReportForm->render('type'); ?>
                    </div>
                </div>
				...
				<div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8" style="padding-top: 3px;">
                        <?php echo $ReportForm->render('module'); ?>
                    </div>
                </div>	
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8" style="padding-top: 3px;">
                        <?php echo $ReportForm->render('graphic'); ?>
						<input type="hidden" id="graphics" name="graphics" value="<?php if ($report->graphic == 1) { ?>1<?php } else { ?>0<?php } ?>" />
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-xs-12 col-sm-12 col-md-11 col-lg-11 text-right">
                        <a href="<?php echo $this->url->get('report'); ?>" class="btn btn-default">Cancelar</a>
                        <?php echo $this->tag->submitButton(array('Guardar', 'class' => 'btn btn-sm btn-success', 'data-toggle' => 'tooltip-b3', 'data-placement' => 'bottom', 'title' => 'Recuerda que los campos con asterisco (*) son obligatorios, por favor no los olvides', 'data-original-title' => 'Tooltip on left')); ?>
                    </div>
                </div>
            </form>
        </div>
