...
{% block body %}
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <h2 class="page-header">Editar el reporte <strong>{{report.name}} ({{report.code}})</strong></h2>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <form action = "{{url('report/edit')}}/{{report.idReport}}" method="post" class="form-horizontal block block-default" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8" style="padding-top: 3px;">
						...
						<input type="hidden" id="graphics" name="graphics" value="{% if report.graphic == 1%}1{% else %}0{% endif %}" />
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-xs-12 col-sm-12 col-md-11 col-lg-11 text-right">
                        <a href="{{ url('report') }}" class="btn btn-default">Cancelar</a>
