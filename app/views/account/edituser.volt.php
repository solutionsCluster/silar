...
<html>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('.bootstrap-switch').on('switchChange.bootstrapSwitch', function(event, state) {
                ...
                $.ajax({
                    url: "<?php echo $this->url->get('account/changeuserstatus'); ?>/<?php echo $account->idAccount; ?>" + idUser,
                    type: "POST",			
                    data: {},
                    error: function(msg){
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <h2 class="page-header">Editar el usuario <strong><?php echo $user->userName; ?></strong> de la cuenta <strong><?php echo $account->name; ?></strong></h2>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <form action = "<?php echo $this->url->get('account/edituser'); ?>/<?php echo $account->idAccount; ?>/<?php echo $user->idUser; ?>" method="post" class="form-horizontal block block-default" role="form">
                ...
                <div class="form-group">
                    <div class="col-xs-12 col-sm-12 col-md-11 col-lg-11 text-right">
                        <a href="<?php echo $this->url->get('account/showusers'); ?>/<?php echo $account->idAccount; ?>" class="btn btn-sm btn-default">Cancelar</a>
                        <?php echo $this->tag->submitButton(array('Guardar', 'class' => 'btn btn-sm btn-success', 'data-toggle' => 'tooltip', 'data-placement' => 'left', 'title' => 'Recuerda que los campos con asterisco (*) son obligatorios, por favor no los olvides', 'data-original-title' => 'Tooltip on left')); ?>
                    </div>
                </div>
            </form>
        </div>
