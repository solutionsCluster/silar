...
{% block body %}
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <h2 class="page-header">Crear un nuevo usuario en la cuenta <strong>{{account.name}}</strong></h2>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <form action = "{{url('account/newuser')}}/{{account.idAccount}}" method="post" class="form-horizontal block block-default" role="form">
                ...
                <div class="form-group">
                    <div class="col-xs-12 col-sm-12 col-md-11 col-lg-11 text-right">
                        <a href="{{ url('account/showusers') }}/{{account.idAccount}}" class="btn btn-default">Cancelar</a>
