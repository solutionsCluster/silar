...
<html>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <h2 class="page-header">Crear un nuevo usuario en la cuenta <strong><?php echo $account->name; ?></strong></h2>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <form action = "<?php echo $this->url->get('account/newuser'); ?>/<?php echo $account->idAccount; ?>" method="post" class="form-horizontal block block-default" role="form">
                ...
                <div class="form-group">
                    <div class="col-xs-12 col-sm-12 col-md-11 col-lg-11 text-right">
                        <a href="<?php echo $this->url->get('account/showusers'); ?>/<?php echo $account->idAccount; ?>" class="btn btn-default">Cancelar</a>
