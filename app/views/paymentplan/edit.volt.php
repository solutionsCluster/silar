...
<html>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <h2 class="page-header">Editar plan de pago con código <?php echo $payment->idPaymentplan; ?></h2>
        </div>
    </div>

    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <form action="<?php echo $this->url->get('paymentplan/edit'); ?>/<?php echo $payment->idPaymentplan; ?>" method="Post" class="form-horizontal block block-default" role="form">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10" style="margin-top: 3px;">
                        <select name="reports[]" class="select2" multiple="multiple">
                            <?php foreach ($reports as $report) { ?>
                                <option value="<?php echo $report->idReport; ?>" <?php foreach ($pxr as $p) { ?><?php if ($p->idReport == $report->idReport) { ?>selected<?php } ?><?php } ?>>
