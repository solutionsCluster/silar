...
<html>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <h2 class="page-header">Cambiar la contraseña del usuario <strong><?php echo $user->userName; ?></strong></h2>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <form action="<?php echo $this->url->get('user/changepassword'); ?>/<?php echo $user->idUser; ?>" method="post" class="form-horizontal block block-default" role="form">
                ...
                <div class="form-group">
                    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 text-right">
                        ...
                        <?php echo $this->tag->submitButton(array('Cambiar', 'class' => 'btn btn-success tooltip-b3 btn-sm', 'data-toggle' => 'tooltip', 'data-placement' => 'left', 'title' => 'Recuerda que los campos con asterisco (*) son obligatorios, por favor no los olvides', 'data-original-title' => 'Tooltip on left')); ?>
                    </div>
                </div>
            </form>
        </div>
